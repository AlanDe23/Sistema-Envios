...
namespace Envios.Application.Services
{
    public class PedidoService : IPedidoService
    {
        ...
        public async Task<Pedido> CrearPedidoAsync(CreatePedidoDto dto)
        {
        ...
        public async Task<Pedido> AsignarPedidoAsync(AsignarPedidoDto dto)
        {
            var pedido = await _repositorioPedido.GetByIdAsync(dto.IdPedido);
        ...
        public async Task<Pedido> UpdatePedidoAdminAsync(UpdatePedidoAdminDto dto)
        {
            var pedido = await _repositorioPedido.GetByIdAsync(dto.IdPedido);
        ...
        public async Task<IEnumerable<GetPedidoResumenDto>> GetPedidosResumenAsync()
        {
        ...
        {
            var pedido = await _repositorioPedido.GetByIdAsync(id);
            if (pedido == null)
                return false;
